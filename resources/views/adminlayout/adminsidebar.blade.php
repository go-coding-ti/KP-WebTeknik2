        ...
        <li class="nav-item" id="sidebarManajemen">
          ...
          <div id="collapseStaff" class="collapse" aria-labelledby="headingKI" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="/admin/jabatan"><i class="fas fa-fw fa-user-tie"></i>  Jabatan Pimpinan</a>
              <a class="collapse-item" href="/admin/pegawai/jabatan"><i class="fas fa-fw fa-user-tie"></i>  Jabatan Tata Usaha</a>
              <a class="collapse-item" href="/admin/management" ><i class="fas fa-fw fa-sitemap"></i>  Pejabat Pimpinan</a>
              <a class="collapse-item" href="/admin/staf"><i class="fas fa-fw fa-user"></i>  Staf Pengajar</a>
              <a class="collapse-item" href="/admin/pegawai"><i class="fas fa-fw fa-user"></i>  Pegawai</a>
            </div>
          </div>
        </li>
