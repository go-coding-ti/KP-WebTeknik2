        ...
        @foreach($pegawais as $pegawai)
            <div class="col p-0 px-1 mb-3">
                <div class="card bg-grey hover border-0 h-100">
                    ...
                    <img src="{{ $pegawai->foto }}" class="card-img-top mb-1" alt="...">
                    <div class="card-body p-3 text-center">
                        <h5 class="card-title fw-bold fs-5">{{ $pegawai->nama }}</h5>
                        <p class="card-text fw-bold mt-3">{{ $pegawai->jabatan->jabatan_eng }}</p>
                    </div>
                    </a>
        ...
        @foreach($pegawais as $pegawai)
            <div class="col p-0 px-1 mb-3">
                <div class="card bg-grey hover border-0 h-100">
                    ...
                    <div class="card-body p-3 text-center">
                        <h5 class="card-title fw-bold fs-5">{{ $pegawai->nama }}</h5>
                        <p class="card-text fw-bold mt-3">{{ $pegawai->jabatan->jabatan_ina }}</p>
                    </div>
                    </a>
                    <div class="card-footer p-3 d-flex justify-content-between border-0">
