        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          @foreach ($data as $i => $agenda)
            <tr>
              ...
              <td class="text-center"><a style="margin-right:7px" href="/admin/events/show/{{$agenda->kategori->kategori_lower}}/{{$agenda->title_slug}}"><button type="button" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></button></a><a style="margin-right:7px" class="btn btn-info btn-sm" href="/admin/events/{{$agenda->id}}/edit" ><i class="fas fa-pencil-alt" ></i></a><a class="btn btn-danger btn-sm" onclick="deleteAgenda({{$agenda->id}})" href="#"><i class="fas fa-trash"></i></a></td>
            </tr>
          @endforeach
          </tbody>
        </table>
