...
@section('title', 'Edit Staf Pengajar')
@section('content')

<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Staf Pengajar</h1>
    <p class="mb-4">Edit Staf Pengajar Fakultas Teknik Universitas Udayana</p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form id="form-product" method="post" action="{{route('admin-staff-update', $staf->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="title">Nama</label>
                    <input type="text" class="form-control @error ('nama') is-invalid @enderror"  value="{{$staf->nama}}" id="nama" name="nama" placeholder="Masukkan nama" required>
                    @error('nama')
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('nip') is-invalid @enderror" name="nip" value="{{$staf->nip}}" placeholder="Masukkan NIP" required>
                    @error('nip')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="date" class="form-control @error ('tanggal') is-invalid @enderror" name="tanggal" value="{{$staf->tanggal_lahir}}" placeholder="Masukkan tanggal lahir" required>
                    @error('tanggal')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('email') is-invalid @enderror" value="{{$staf->email}}" id="email" name="email" placeholder="Masukkan email" required>
                    @error('email')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('telepon') is-invalid @enderror" name="telepon" value="{{$staf->nomor_telepon}}" placeholder="Masukkan nomor telepon" required>
                    @error('telepon')
                        <div class="invalid-feedback text-start">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="text" class="form-control @error ('sinta') is-invalid @enderror" value="{{$staf->sinta}}" id="sinta" name="sinta" placeholder="Masukkan link SINTA">

                </div>
                <div class="col-lg-6 col-sm-12">
                    <label for="title">Scopus</label>
                    <input type="text" class="form-control @error ('scopus') is-invalid @enderror" value="{{$staf->scopus}}" name="scopus" placeholder="Masukkan link Scopus">
                </div>
            </div>
            <div class="form group mt-4">
                <label for="title">Alamat</label>
                <input type="text" class="form-control @error ('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{$staf->alamat}}" placeholder="Masukkan alamat" required>
                @error('alamat')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form group mt-4">
                ...
                <input type="text" class="form-control @error ('s1') is-invalid @enderror" id="s1" name="s1" value="{{$staf->pendidikan_s1}}" placeholder="Masukkan pendidikan S1" required>
                @error('s1')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form group mt-4">
                ...
                <input type="text" class="form-control @error ('s2') is-invalid @enderror" id="s2" name="s2" value="{{$staf->pendidikan_s2}}" placeholder="Masukkan pendidikan S2" required>
                @error('s2')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form group mt-4">
                ...
                <input type="text" class="form-control @error ('s3') is-invalid @enderror" id="s3" name="s3" value="{{$staf->pendidikan_s3}}" placeholder="Masukkan pendidikan S3">
            </div>
            <div class="form-group form-group mt-4">
                <label for="description">Biografi Bahasa Indonesia</label>
                <textarea id="content_ina" class="form-control @error ('biografi_ina') is-invalid @enderror" name="biografi_ina" rows="8" required>{{$staf->biografi_ina}}</textarea>
                @error('biografi_ina')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group form-group mt-4">
                ...
                <textarea id="content_ina" class="form-control @error ('biografi_eng') is-invalid @enderror" name="biografi_eng" rows="8" required>{{$staf->biografi_eng}}</textarea>
                @error('nama')
                    <div class="invalid-feedback text-start">
                        {{ $message }}
                    </div>
