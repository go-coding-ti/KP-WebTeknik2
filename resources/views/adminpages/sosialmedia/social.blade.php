              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                @foreach ($data as $i => $sosmed)
                  <tr>
                    ...
                    <td>{{$sosmed->link}}</td>
                    <td class="text-center"><a style="margin-right:7px" onclick="show({{$sosmed->id}},'show')"><button type="button" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></button></a><a style="margin-right:7px" class="btn btn-info btn-sm" onclick="show({{$sosmed->id}},'edit')" href="#"><i class="fas fa-pencil-alt" ></i></a><a class="btn btn-danger btn-sm" onclick="deletePost({{$sosmed->id}})" href="#"><i class="fas fa-trash"></i></a></td>
                  </tr>
                @endforeach
                </tbody>
              </table>
