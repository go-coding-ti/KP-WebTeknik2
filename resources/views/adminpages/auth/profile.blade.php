                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin-profile-update')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error ('nama') is-invalid @enderror" id="inputnip" type="text" name="nama" placeholder="Masukkan nama" value="{{auth()->guard()->user()->nama}}" required/>
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error ('nip') is-invalid @enderror" id="inputEmailAddress" type="text" name="nip" placeholder="Masukkan NIP" value="{{auth()->guard()->user()->nip}}" required/>
                            @error('nip')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
