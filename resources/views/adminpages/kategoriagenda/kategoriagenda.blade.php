...
@section('title', 'Daftar Kategori Agenda')
@section('content')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="/admin/category/agenda/store" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
