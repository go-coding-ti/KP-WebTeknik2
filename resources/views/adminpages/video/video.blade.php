        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          @foreach ($data as $i => $video)
            <tr>
              ...
              <td class="text-center"><a style="margin-right:7px" href="/admin/videos/show/{{$video->judul_slug}}"><button type="button" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></button></a><a style="margin-right:7px" class="btn btn-info btn-sm" href="/admin/videos/{{$video->id}}/edit" ><i class="fas fa-pencil-alt" ></i></a><a class="btn btn-danger btn-sm" onclick="deletevideo({{$video->id}})" href="#"><i class="fas fa-trash"></i></a></td>
            </tr>
          @endforeach
          </tbody>
        </table>
