...
<div class="container mt-5 pt-5">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
    <h1 class="h4 fw-bold text-light border-2 border-bottom border-danger p-2">Lecture & Staf</h1>
...
<div class="container">
  <div class="card-header d-flex justify-content-center justify-content-md-start border-light">
    <ul class="nav nav-pills small">
        ...
        <li class="nav-item"><a class="nav-link p-2" id="tab-data-tu" href="#data-tu" data-toggle="tab">Staf</a></li>
              ...
              <div class="card bg-grey hover border-0 h-100">
                <a href="#" class="link-light text-decoration-none ">
                  ...
                  <div class="card-body p-3 text-center">
                      ...
                      <p class="card-text fw-bold mt-3">{{$staf->jabatan->jabatan_eng ?? '-'}}</p>
                  </div>
                </a>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-2">
              <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link active text-white" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#kepala_bidang" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Head of Administration</button>
                <button class="nav-link text-white" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#sub_bidang_a" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Education & Collaboration Division</button>
                      ...
                      @if($staf->jabatan->sub_bidang == 'kepala_bidang')
                        <div class="col p-0 px-1 mb-3">
                          <div class="card bg-grey hover border-0 h-100">
                            ...
                            <div class="card-footer p-3 d-flex justify-content-between border-0">
                              <a  class="btn btn-primary p-1 my-1" href="{{ route("Detail Pegawai", ['language'=>app()->getLocale(), 'nama_slug' => $staf->nama_slug]) }}">See More</a>
                            </div>
                          </div>
                        </div>
                      @endif
                          ...
                          <div class="card-body p-3 text-center">
                              ...
                              <ul class="list-unstyled">
                                @foreach($staf->staf_prodi as $prodi)
                                  <li class="card-text fw-bold">{{$prodi->prodi->prodi_eng ?? '-'}}</li>
                                @endforeach
                              </ul>
                          </div>
                        </a>
                      ...
                      <div class="card bg-grey hover border-0 h-100">
                        <a href="#" class="link-light text-decoration-none ">
                          ...
                          <div class="card-body p-3 text-center">
                              <h5 class="card-title fw-bold fs-5">{{$staf->nama}}</h5>
                              @foreach($staf->staf_prodi as $prodi)
                                <p class="card-text fw-bold">{{$prodi->prodi->prodi_eng ?? '-'}}</p>
                              @endforeach
                          </div>
                        </a>
                        <div class="card-footer p-3 d-flex justify-content-between border-0">
            ...
            <div class="col-sm-12 col-md-2">
              <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                @foreach($prodis as $prodi)
                  <button class="nav-link @if($loop->iteration == 1) active @endif text-white" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#prodi{{ $prodi->id }}" type="button" role="tab" aria-controls="@if($loop->iteration == 1) v-pills-home @else v-pills-profile @endif" aria-selected="@if($loop->iteration == 1) true @else false @endif">{{ $prodi->prodi_eng }}</button>
                @endforeach
              </div>
            </div>
            <div class="col-sm-12 col-md-10">
                        ...
                        @if($staf->jabatan->sub_bidang == 'kepala_bidang')
                          <div class="col p-0 px-1 mb-3">
                            <div class="card bg-grey hover border-0 h-100">
                              ...
                              <div class="card-footer p-3 d-flex justify-content-between border-0">
                                <a  class="btn btn-primary p-1 my-1" href="{{ route("Detail Pegawai", ['language'=>app()->getLocale(), 'nama_slug' => $staf->nama_slug]) }}">Lihat Lebih Lanjut</a>
                              </div>
                            </div>
                          </div>
                        @endif
