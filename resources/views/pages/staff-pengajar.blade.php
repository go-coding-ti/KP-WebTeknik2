    ...
    <div class="row">
      <div class="col-sm-12 col-md-2">
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button class="nav-link active text-white" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#pengajar" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Teaching</button>
          <button class="nav-link text-white" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#staff" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Staff</button>
        </div>
      </div>
      <div class="col-sm-12 col-md-10">
        <div class="tab-content bg-grey text-white rounded p-3" id="v-pills-tabContent">
          <div class="tab-pane fade show active" id="pengajar" role="tabpanel" aria-labelledby="v-pills-home-tab">
          ...
          <div class="tab-pane fade" id="staff" role="tabpanel" aria-labelledby="v-pills-profile-tab">
            <div class="row row-cols-1 row-cols-lg-3 row-cols-lg-3 px-3 pt-2">
              @foreach($stafs as $staf)
              <div class="col p-0 px-1 mb-3">
                <div class="card bg-grey hover border-0 h-100">
...
@if (App::getLocale() == 'id')
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-2">
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button class="nav-link active text-white" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#pengajar" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Pengajar</button>
          <button class="nav-link text-white" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#staff" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Staff</button>
        </div>
      </div>
      <div class="col-sm-12 col-md-10">
